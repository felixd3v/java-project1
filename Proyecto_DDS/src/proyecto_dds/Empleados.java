...
public class empleados {
    ...
    public empleados(String nombre, String apellido, String nombre2, String apellido2, String cedula, String fechaN, String direccion, String telefono, double horastrabajadas, double salarioporhora, double salariobruto, double segurososcial, double seguroeducativo, double salarioneto) {
        this.nombre = nombre;
